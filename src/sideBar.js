...
const SideBar = () => {
  return (
    <div>
      <div
        className="d-flex flex-column align-items-stretch flex-shrink-0 bg-white m-md-2 m-lg-0 ms-sm-5"
        style={{ width: "380px"}}
      >
        <a
          href="/"
        ...
        <div className="list-group list-group-flush border-bottom scrollarea bg-secondary">
          <a
            href="#"
          ...
          >
            <div className="d-flex w-100 align-items-center justify-content-between">
              <strong className="mb-1">What's happening</strong>
              <small>Wed</small>
            </div>
